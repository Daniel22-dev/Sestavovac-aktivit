# Sestavovač aktivit · ACTIVA 0.5.5 — etapa P2
...
- Vratná migrace aplikačních dat do prefixu `ghrab.activity-builder.*`; záloha se vytváří před odstraněním starých klíčů.
...
- PWA cache `ghrab-activity-builder-v0.5.5` a aktualizační zpráva `GHRAB_SKIP_WAITING`.
